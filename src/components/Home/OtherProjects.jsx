    ...
    <div className="min-h-fit bg-[#111120] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold">Other Projects</h2>
            ...
            <div className="grid gap-8 md:grid-cols-2 mt-6">
              {caseStudies.map((caseStudy, index) => (
                ...
                >
                  ...
                  <p className="mt-4 font-semibold">{caseStudy.results}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 mt-6">
              {partnerships.map((partnership, index) => (
                ...
                >
                  ...
                  <p className="mt-2">{partnership.description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 mt-6">
              {awards.map((award, index) => (
                ...
                >
                  ...
                  <h4 className="text-2xl font-bold mt-4">{award.title}</h4>
